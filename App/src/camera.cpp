...
void Camera::Update()
{
    ...
    ImGui::SliderFloat3("Up direction", &mUp.x, -30.0f, 30.f, "%.2f");
    ImGui::SliderFloat3("Position", &mPosition.x, -30.0f, 30.f, "%.2f");
    ImGui::SliderFloat3("Looking at", &mLookAt.x, -30.0f, 30.f, "%.2f");
    ImGui::End();
